...
<head>
	...
	<link rel="stylesheet" href="static/css/pie_pagina.css" th:href="@{css/pie_pagina.css}">
	<link rel="stylesheet" href="static/css/Encabezado-Cliente.css" th:href="@{css/Encabezado-Cliente.css}">
	<link rel="stylesheet" href="static/css/PQRS.css" th:href="@{css/PQRS.css}">
</head>
<style>
	.container-fluid {
...
<body>
	...
	<div style="background-color: lightsteelblue;">
		<h2 style="margin-left: 5%; padding-top: 1%;">Realice la calificación de su servicio</h2>
		<p class="texto" style="padding-bottom: 1%;">Nuestra empresa se preocupa porque tu servicio se preste de la 
	mejor manera, para nosotros es muy importante que registres la calificacion o valorizacion de los servicios que 
	solicitas, de esta manera podremos mejorar la eficiencia y productividad de cada servicio. </p>
	</div>
	...
	<div>
		...
		<div class="row" style="padding-bottom: 2%;">
			<div class="col-md-3">
			<img style="margin-left: 45%;" src="https://i.ibb.co/FJJJTq5/pngegg.png" alt="pngegg" border="0"></a>
			</div>
			<div class="col-md-9">
				<h4>Califica tu servicio</h4>
				<p>Genera una valorizacion del servicio que recibiste, recuerda que con esta informacion 
				mejoraremos cada dia mas la prestacion del mismo.
				</p>
				<a href="{{ route('calificaciones.create') }}">
					<button class="w3-button w3-blue w3-hover-black" style="border-radius: 8px; margin-left: 32%;">Generar
						Calificación</button>
				</a>
			</div>
		</div>
		<div class="row" style="margin-bottom: 2%; margin-top: 2%; padding-bottom: 2%;">
