...
<link rel="stylesheet" href="static/css/Trabaja-con-nosotros.css"
	th:href="@{css/Trabaja-con-nosotros.css}" media="screen">
...
.cuadro {
  margin: 39px 237px 60px 288px; 
}
.boton-1 {
  display: table;
  padding: 10px 30px;
  background-color: rgb(21, 113, 233);
  color: white;
  margin-left: 30%;
}
.tamaño-cuadro {
	...
	<div class="largo-cuadros">
		<section>
			<div class="largo-cuadros-1">
				<h2 class="centrar-titulo negrilla">Trabaja con nosotros</h2>
				<div class="cuadro">
					<div>
						<label>Nombre completo</label> <input
							placeholder="Introduzca su nombre completo" class="tamaño-cuadro">
					</div>
					<div>
						<label>Correo electrónico</label> <input
							placeholder="Introduzca su dirección de correo de contacto"
							class="tamaño-cuadro">
					</div>
					<div>
						<label>Dirección</label> <input placeholder="Ingrese su dirección"
							class="tamaño-cuadro">
					</div>
					<div>
						<label>Número de celular</label> <input
							placeholder="Ingrese su número de celular (ejemplo, +57 3105234852)"
							class="tamaño-cuadro">
					</div>
					<label style="padding-top: 20px;">Cargar hoja de vida</label>
					<div>
						<a href="#" class="boton-1" style="margin-top: -8px;">Seleccionar...</a><label
							style="color: grey;">Subir su hoja de vida</label> <a href="#"
							class="boton-1" style="margin-top: 4px;">Enviar</a>
					</div>
				</div>
		</section>
		<footer>
