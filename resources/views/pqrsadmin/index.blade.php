...
<body style="font-family:Arial, Helvetica, sans-serif">
	...
	<div class="container">
		<div class="row">
			...
			<h2 style="color:darkblue; font-weight:bold;">Reportes PQRS</h2>
		</div>
		@if (sizeof($pqrs) > 0)
			...
			<tbody>
				...
				<td>{{ $pqr->idpqrs }}</td>
					...
					<td class="text-center">
						<a href="{{ route('respuesta.create') }}" class="btn btn-info" style="margin-left:-20px;">Respuesta</a>
						<a href="{{ route('pqrsadmin.edit', $pqr) }}" class="btn btn-info" style="background-color:blue; margin-left: 10px;">Estado</a>
					</td>
				</tr>
				@endforeach
			</tbody>
