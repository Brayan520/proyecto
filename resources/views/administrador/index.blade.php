...
<body style="font-family:Arial, Helvetica, sans-serif">
				<div class="w3-bar w3-black " style="margin-top: -23px;">
					...
					<div class="w3-dropdown-hover">
						<a style="text-decoration:none" href="reportes.html" class="w3-button">Reportes</a>
					</div>
					<div class="w3-dropdown-hover">
						<a style="text-decoration:none" href="pqrsadmin.html" class="w3-button">PQRS</a>
					</div>
					<div class="w3-dropdown-hover">
				...
				<div class="fondo-blanco">
					<div class="margen-texto">
						...
						<div class="icono-reportes">
							<a href="reportes.html"><img src="https://i.ibb.co/ByPnvn7/2.png" alt="">
						</div>
						</a>
					</div>
				</div>
				<div class="fondo-blanco">
					<div class="margen-texto">
						...
						<div class="icono-pqrs">
							<a href="pqrsadmin.html"><img src="https://i.ibb.co/ByPnvn7/2.png" alt="">
						</div>
						</a>
					</div>
				</div>
