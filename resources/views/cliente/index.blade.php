...
<body>
				...
				<div class="w3-bar w3-black" style="margin-top: -23px;">
					...
					<a style="text-decoration: none;" href="catalogoservicios.html" class="w3-bar-item w3-button">Catalogo
						de servicio</a> <a style="text-decoration: none;" href="vacantes.html" class="w3-bar-item w3-button">Trabaja
