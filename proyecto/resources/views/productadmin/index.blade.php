...
<body style="font-family:Arial, Helvetica, sans-serif">
	...
	<div class="container">
		<div class="row">
			...
			<h2 style="color:darkblue; font-weight:bold;">Reportes de Servicios</h2>
		</div>
...
<br>
		...
		<br>
		<div class="container">
		<a href="{{ route('productadmin.create') }}" class="btn btn-info ti-pencil-alt" style="margin-left:-20px;"></a>
		<hr>
	<table id="example" class="display nowrap" style="width:100%">
			...
			<tbody>
				...
				<td>{{ $product->id }}</td>
					...
					<td class="text-center">{{ $product->image_path }}</td>
