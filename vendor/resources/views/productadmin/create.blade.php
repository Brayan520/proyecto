...
<center>
	...
	<div class="container">
		<div class="row">
            <h2 style="font-weight:bold">Agregar Servicio:</h2>
            <hr>

        <form action="{{ route('productadmin.store') }}" method="POST">
			@csrf
			<div class="col-md-6">
				<label for="name" class="form-label" style="font-weight: bold;">Nombre del servicio:</label>
...
<br>
            <div class="col-md-6">
				<label for="details" class="form-label" style="font-weight: bold;">Detalle:</label>
...
<br>
            <div class="col-md-6">
				<label for="price" class="form-label" style="font-weight: bold;">Precio del servicio:</label>
...
<br>
            <div class="col-md-6">
				<label for="image_path" class="form-label" style="font-weight: bold;">Imagen URL:</label>
